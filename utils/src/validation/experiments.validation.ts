    ...
    metadata: Type.Object(
      {
        ...
        lobbyConfig: Type.Optional(LobbyConfigSchema),
        isGroup: Type.Optional(Type.Boolean()),
        numExperiments: Type.Optional(Type.Number()),
        isMultiPart: Type.Optional(Type.Boolean()),
        dividerStageId: Type.Optional(Type.String()),
        lobbyWaitSeconds: Type.Optional(Type.Number()),
