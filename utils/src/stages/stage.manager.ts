...
import {NegotiationProfileStageHandler} from './negotiation_profile_stage.manager';
import {NegotiationPayoutStageHandler} from './negotiation_payout_stage.manager';
...
export class StageManager {
  ...
  constructor() {
    ...
    this.handlerMap.set(
      ...
      new NegotiationProfileStageHandler(),
    );
    this.handlerMap.set(
      StageKind.NEGOTIATION_PAYOUT,
      new NegotiationPayoutStageHandler(),
    );
