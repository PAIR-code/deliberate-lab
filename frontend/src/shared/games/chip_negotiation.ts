...
const CHIP_INFO_STAGE_INSTRUCTIONS = createInfoStage({
  ...
  infoLines: [
    ...
    "You know your own chip valuations, and you know that everyone values **🟢 green** chips the same, at $0.05 per chip. However, you do not know the other players' valuations for red and blue chips.",
    '\n**What this means:**',
