...
function createAllocationStage(
  ...
  return createMultiAssetAllocationStage({
    ...
    descriptions: createStageTextConfig({
      ...
      infoText: `Ensure your chosen percentages for **${charityGroup.join(
        ', ',
      )}** add up to 100%.`,
    }),
...
function createInitialMediatorSurveyStage(): StageConfig {
  return createSurveyStage({
    ...
    descriptions: createStageTextConfig({
      primaryText: 'Background on AI assistance',
    }),
    questions: [
      createScaleSurveyQuestion({
        id: 'ai-familiarity',
      ...
      createTextSurveyQuestion({
        id: 'ai-app-usage',
        questionTitle: 'What kind of work do you use AI assistants for? (If none, put NA)',
      }),
      createScaleSurveyQuestion({
        id: 'ai-comfort',
        questionTitle:
  ...
  return createSurveyPerParticipantStage({
    ...
    questions: [
      ...
      createScaleSurveyQuestion({
        id: 'felt-comfortable',
        questionTitle:
          'I would discuss further topics / charities with this participant.',
        ...LIKERT_SCALE_PROPS,
      }),
      createScaleSurveyQuestion({
  ...
  return createSurveyPerParticipantStage({
    ...
    questions: [
      ...
      createTextSurveyQuestion({
        ...
        questionTitle:
          'Do you have any other feedback for this participant? (If not, reply "NA")',
      }),
    ],
  });
}
  ...
  return createSurveyStage({
    ...
    questions: [
      createTextSurveyQuestion({
        id: 'feedback-design',
        questionTitle:
          'What, if any, feedback do you have around the design of the experiment? (If none, reply NA)',
      }),
      createTextSurveyQuestion({
        id: 'feedback-instructions',
        questionTitle:
          'What stages, if any, had unclear or poorly-defined instructions? (If none, reply NA)',
      }),
      createTextSurveyQuestion({
        id: 'feedback-improvements',
        questionTitle:
          'What could be added to strengthen the coherence or value of these experiments? (If none, reply NA)',
      }),
      createTextSurveyQuestion({
        id: 'feedback-bugs',
        questionTitle:
          'Did you experience any apparent bugs during any portion of the experiment? (If none, reply NA)',
      }),
    ],
  });
}