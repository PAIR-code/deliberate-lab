...
import {
  ...
  getRepresentativePromptContext,
    ...
    if (participant.isObserver && participant.hasRepresentative) {
      ...
      const repAgentProfile = createParticipantProfileExtended({
        ...
        agentConfig: {
          ...
          promptContext: getRepresentativePromptContext(
            observerName,
            experiment.representativePromptContext,
          ),
          modelSettings:
    ...
    for (let i = 0; i < numOtherAgents; i++) {
      ...
      if (cohortHasObserver) {
        ...
        if (agentProfile.agentConfig) {
          ...
          agentProfile.agentConfig.promptContext =
            getRepresentativePromptContext(
              representedName,
              experiment.representativePromptContext,
            );
