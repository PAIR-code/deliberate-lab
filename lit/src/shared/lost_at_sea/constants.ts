...
export const LAS_PE2_SURVEY: QuestionConfig[] = [
  {
    id: 0,
    kind: SurveyQuestionKind.MultipleChoice,
    questionText: "We also give you the opportunity to update your guess about how well you did in Part 1 compared to the other 3 members of your group. Please indicate your answer by clicking on one of the options below. If you think you earned the highest number of good answers in your group, click on the first option. If you think you earned the second highest number of good answers, click on the second option, and so on.",
    options: [
      {
        id: 0,
...
export const LAS_WTL_2_DESCRIPTION = "Please indicate your willingness to become the group leader.";

export const LAS_WTL_2_SURVEY: QuestionConfig[] = [
  {
    id: 0,
    kind: SurveyQuestionKind.Scale,
    questionText: "How much would you like to become the group leader in Part 3?",
    lowerBound: 'Not at all',
    upperBound: 'Very much',
  },
];

export const LAS_LEADER_REMINDER = "Your group must elect a leader whose role is to answer on behalf of the group the same types of questions you have just seen. In this scenario, the leader is the only one who chooses the most useful items for survival from pairs, and their answers determine the payment for each member of the group."
